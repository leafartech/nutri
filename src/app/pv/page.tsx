                ...
                <Section classNameS="py-16 py-32 px-4 border-y radial-02 2bg-[#3b3434]" id="preco">
                    <div className="w-full max-w-md rounded-xl text-center border text-black bg-gradient-to-br from-zinc-100 to-zinc-300 b2g-[#514746]">
                        ...
                        <div className="text-black flex flex-col items-center justify-center gap-4 px-4 pt-8 pb-6">
                            ...
                            <a href="https://pay.kiwify.com.br/J8aCY6f" className="max-w-md w-full text-center bg-[#b3c674] border border-[#FFE8D8] uppercase text-white font-semibold text-sm py-4 px-2 rounded-xl">Quero garantir minha certificação</a>
                        </div>
                    </div>
                </Section>
                <Section classNameS="py-12 sm:py-24 px-4">
